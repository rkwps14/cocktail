                    ...
                    <div class="row g-0">
                        ...
                        <div class="card-body p-md-5 mx-md-4">
                            ...
                            <div class="text-center pt-1 mb-5 pb-1">
                                <button class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3" id="registerBtn" type="button">Register</button>
                                <!-- <a class="text-muted" href="#!">Forgot password?</a> -->
                            </div>

                            <div class="d-flex align-items-center justify-content-center pb-4">
                                <p class="mb-0 me-2">Already account?</p>
                                <button type="button" class="btn btn-outline-danger" id="loginBtn">Login</button>
                            </div>
